...
[`DateTime`](https://www.rdocumentation.org/packages/base/topics/DateTimeClasses) object, in the same way as setting
...
to print the time, as the default character representation does not include time. For example:
...
`shinyTime::shinyTimeExample()` function after installing this package.
